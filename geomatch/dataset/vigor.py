...
class VigorDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        for city in self.cities:
            df_tmp = pd.read_csv(f'{data_folder}/splits/{city}/satellite_list.txt', header=None, sep='\s+')
        ...
        for city in self.cities:
            ...
            if same_area:
                df_tmp = pd.read_csv(f'{data_folder}/splits/{city}/same_area_balanced_train.txt', header=None, sep='\s+')
            else:
                df_tmp = pd.read_csv(f'{data_folder}/splits/{city}/pano_label_balanced.txt', header=None, sep='\s+')
...
class VigorDatasetTrainGeomatch(Dataset):
...
class VigorDatasetEval(Dataset):
    ...
    def __init__(self,
        ...
        for city in self.cities:
            ...
            if same_area:
                df_tmp = pd.read_csv(f'{data_folder}/splits/{city}/same_area_balanced_{split}.txt', header=None, sep='\s+')
            else:
                df_tmp = pd.read_csv(f'{data_folder}/splits/{city}/pano_label_balanced.txt', header=None, sep='\s+')
...
class VigorDatasetTrainGeomatch_All(Dataset):
    ...
    def __init__(self,
        ...
        for city in self.cities:
            ...
            if same_area:
                train_df = pd.read_csv(f'{data_folder}/splits/{city}/same_area_balanced_train.txt', header=None, sep='\s+')
                test_df = pd.read_csv(f'{data_folder}/splits/{city}/same_area_balanced_test.txt', header=None, sep='\s+')
                df_tmp = pd.concat([train_df, test_df], axis=0).reset_index(drop=True)
            else:
                df_tmp = pd.read_csv(f'{data_folder}/splits/{city}/pano_label_balanced.txt', header=None, sep='\s+')
...
class VigorDatasetEval_All(Dataset):
    ...
    def __init__(self,
        ...
        if max_samples is not None and max_samples < len(self.images):
            ...
            self.df_ground = self.df_ground.head(max_samples)      
