...
class LimitedFoV(ImageOnlyTransform):
    def __init__(self, fov=360., p=1.0):
        super(LimitedFoV, self).__init__(p=p)
        self.fov = fov
...
def get_transforms_train_geomatch(image_size_sat,
                         img_size_ground,
                         mean=[0.485, 0.456, 0.406],
                         std=[0.229, 0.224, 0.225],
                         ground_cutting=0,
